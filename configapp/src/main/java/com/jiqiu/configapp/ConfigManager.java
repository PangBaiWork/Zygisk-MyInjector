...
public class ConfigManager {
    ...
    public static void cpConfigToApp(String packageName){
            String targetPath = "/data/data/" + packageName + "/files/config.json";
            
            Shell.Result copyResult = Shell.cmd("cp " + CONFIG_FILE + " " + targetPath).exec();
